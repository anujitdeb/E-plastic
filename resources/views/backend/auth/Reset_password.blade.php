...
Company Name                 </span>
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">Enter Your New Password</h2>
                    ...
                    <form method="POST" action="{{route('dashboard.reset_password_submit')}}">
                        <div class="intro-x mt-8">

                            @csrf
                            <label class="cursor-pointer select-none" for="Email">Email</label>
                            <input id="email" type="hidden" class="intro-x login__input form-control py-3 px-4 block"
                                   placeholder="Email " name="id" value="{{$admin->id}}" >

                            <label class="cursor-pointer select-none" for="Password">Password</label>
                            <input id="email" type="text" class="intro-x login__input form-control py-3 px-4 block"
                                   placeholder="Email " name="password">
                            <label class="cursor-pointer select-none" for="Confirm ">Confirm Password</label>
                            <input id="email" type="text" class="intro-x login__input form-control py-3 px-4 block"
                                   placeholder="Email " name="password_confirmation">
