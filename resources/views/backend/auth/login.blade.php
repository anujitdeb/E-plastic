                ...
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            ...
                            <label>Type : </label>
                            <select name="type" class="from-control sm:ml-auto mt-3 sm:mt-0 sm:w-auto form-select box my-4" style="cursor: pointer" id="type">
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        ...
                        <a href="{{route('registration')}}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register</a>
                    ...
                    @if(Session::has('success'))
                        <div class="alert alert-outline-success" style="margin-top: 10px">
                            {{ session('success') }}
                        </div>
                    @endif--}}
